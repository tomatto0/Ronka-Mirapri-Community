  ...
  return (
    <>
      <div className="rule-block-wrap">
        <h1>이용규칙</h1>
        <p>
          롱카의 룩북을 이용해 주셔서 감사합니다. 사이트 이용 시 아래의 운영
          정책을 반드시 숙지하시고, 원활한 커뮤니티 운영을 위해 협조
          부탁드립니다.
        </p>
      </div>
      ...
      <div className="rule-block-wrap">
        ...
        <div className="rule-list-wrap">
          ...
          <ul>
            <li>
              업로드 이미지는 전신의 아이템이 잘 보이는 세로 사진을 권장합니다.
            </li>
            <li>
            ...
            <li>
              ...
              이미지(모드 사용)는 별도의 통보 없이 삭제될 수 있습니다.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              단, 원색을 알아볼 수 없을 정도의 과도한 보정이 적용된 이미지는
              별도의 통보 없이 삭제될 수 있습니다.
            </li>
          </ul>

          <h3>배경 이미지 기준</h3>
          <ul>
            <li>반드시 파이널판타지14 게임 내 배경을 사용해야 합니다.</li>
            <li>
      ...
      <div className="rule-block-wrap">
        ...
        <ul>
          <li>
            게시물 제재 규정은 파이널판타지14 한국서버 홈페이지 운영정책을
            따릅니다. 해당 정책을 위반하는 게시물은 별도의 안내 없이 수정 또는
            삭제될 수 있습니다.
          </li>
          <li>
      ...
      <div className="rule-list-wrap">
        ...
        <ul>
          <li>
            게시물 중 파이널판타지14 운영정책 제7.4항에 해당하는 ‘홈페이지 제재
            항목’ 대상의 경우 작성자에게 사전통지 없이 해당 게시물을 삭제할 수
            있으며, 이를 작성한 계정은 경고 1회 후 게시글 삭제
          </li>
        </ul>
        ...
        <ul>
          <li>
            파이널판타지14 외의 이미지(타 게임, 실사, 일러스트 등)를 포함한 경우
          </li>
          <li>
        ...
        <ul>
          <li>
            게시글 작성시 의도적으로 잘못된 아이템, 종족, 직업설정을 반복적으로
            입력하여 다른 유저에게 혼란을 줄 경우 경고 1회 부여
          </li>
        </ul>
      </div>
      ...
      <div className="rule-list-wrap">
        ...
        <ul>
          <li>
            본 사이트의 이미지 및 게시물은 파이널판타지14 한국서버 홈페이지
            운영정책을 따릅니다. 해당 정책을 위반하는 게시물은 별도의 안내 없이
            수정 또는 삭제될 수 있습니다.
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            홈페이지 서비스를 일시 중단할 수 있습니다. 이 경우 회사는 사전에 그
            사유 및 중단 기간을 반드시 회원에게 통지합니다. 단, 천재지변,
            전기통신제공업자 등 제삼자의 귀책사유를 근거로 한 경우 등과 같은
            통제할 수 없는 명백한 불가항력적인 사유로 중단되었을 경우는 예외로
            합니다. 이로 인해 발생하는 어떠한 손해에 대해서도 책임을 지지
            않습니다.
          </li>
          <li>
            또한, 관리자는 게시된 이미지 및 게시물 데이터를 별도로 저장할 의무가
            없으므로, 사용자가 필요한 데이터는 직접 백업해 주시기 바랍니다.
          </li>
        </ul>
      </div>
      ...
      <ul>
        <li>
          운영 정책은 필요 시 변경될 수 있으며, 변경된 내용은 별도의 공지를 통해
          안내됩니다.
        </li>
        <li>
          이용규칙 혹은 사이트 이용에 관한 문의사항은{" "}
          <Link href="https://open.kakao.com/me/ronkacloset">오픈채팅</Link>으로
          문의하여 주시기 바랍니다.
        </li>
      </ul>
